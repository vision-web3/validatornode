"""Module for keeping track of supported Vision protocol versions.

"""
import typing

import semantic_version  # type: ignore
from vision.common.protocol import \
...
def get_latest_protocol_version() -> semantic_version.Version:
    """Get the latest supported Vision protocol version.
...
def get_supported_protocol_versions() -> list[semantic_version.Version]:
    """Get all supported Vision protocol versions.
...
def is_supported_protocol_version(version: semantic_version.Version) -> bool:
    """Check if a given version is a supported Vision protocol version.
